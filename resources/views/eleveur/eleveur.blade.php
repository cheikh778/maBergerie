                ...
                <div class="col-12">
                    <div class="row justify-content-center ">
                        <div class="col-lg-6 text-center ">
                            <h1 class="mb-4 heading text-white" data-aos="fade-up" data-aos-delay="100">Liste de mes
                                Moutons</h1>
                ...
                <div class="col-lg-6 mb-4" data-aos="fade-up" data-aos-delay="100">
                    <div class="media-h d-flex h-100">
                        ...
                        <div class="media-h-body">
                            <h2 class="mb-3"><a
                                    href="{{ route('moutons.show', $mouton->id) }}">{{ $mouton->nom }}</a></h2>
                            ...
                            <a href="{{ route('moutons.edit', $mouton->id) }}" class="btn btn-warning">Éditer</a>
                            <form action="{{ route('moutons.destroy', $mouton->id) }}" method="POST"
                                style="display: inline-block;">
                                @csrf
                                @method('DELETE')
                                <button type="submit" class="btn btn-danger"
                                    onclick="return confirm('Êtes-vous sûr de supprimer ce mouton?')">Supprimer</button>
                            </form>
                        </div>
                    </div>
                </div>
