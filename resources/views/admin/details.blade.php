        ...
        <div class="col-12">
          <div class="row justify-content-center ">
            <div class="col-lg-6 text-center ">
              <h1 class="mb-4 heading text-white" data-aos="fade-up" data-aos-delay="100">Détails de L'utilisateur</h1>
      ...
      <div class="row justify-content-between">
        <div class="col-lg-4 mb-5 mb-lg-0">
          ...
          <div class="section-title mb-3" data-aos="fade-up" data-aos-delay="0">
            <h2 class="line-bottom mb-4">{{ $user->nom }} {{ $user->prenom }}</h2>
          </div>

          {{-- <p data-aos="fade-up" data-aos-delay="100">{{ $user->genealogie }}</p> --}}

          <ul class="ul-check list-unstyled mb-5 primary" data-aos="fade-up" data-aos-delay="200">
            <li><strong>Genre :</strong> {{ $user->genre }}</li>
            <li><strong>Adresse :</strong> {{ $user->adresse }}</li>
            <li><strong>Email :</strong> {{ $user->email }}</li>
            <li><strong>Téléphone :</strong> {{ $user->telephone }}</li>
            <li><strong>Profil :</strong> {{ $user->role }}</li>
