        ...
        <div class="col-12">
          <div class="row justify-content-center ">
            <div class="col-lg-6 text-center ">
              <h1 class="mb-4 heading text-white" data-aos="fade-up" data-aos-delay="100">Découvrez Notre Sélection Exclusive de Moutons!</h1>
              <div class="mb-5 text-white desc mx-auto" data-aos="fade-up" data-aos-delay="200">
                <p>
                    🐑Nous sommes fiers de vous proposer une sélection minutieuse de moutons de race, élevés avec soin pour leur santé et leur bien-être.</p>

                    <p>🏞️ Nos éleveurs partenaires sont des professionnels de confiance, engagés dans des pratiques d'élevage responsables et respectueuses des animaux.</p>

                    🌿 Un Avenir Bucolique : Nos moutons apporteront une touche rustique à votre ferme tout en vous offrant des avantages économiques.</p>
              </div>

              <p class="mb-0" data-aos="fade-up" data-aos-delay="300"><a href="{{route('moutons.index')}}" class="btn btn-secondary">Explorer nos moutons</a></p>
    ...
    <div class="col-lg-6 mb-4" data-aos="fade-up" data-aos-delay="100">
        <div class="media-h d-flex h-100">
            ...
            <div class="media-h-body">
                <h2 class="mb-3"><a href="{{ route('moutons.show', $mouton->id) }}">{{ $mouton->nom }}</a></h2>
                <p>Race: {{ $mouton->race }}</p>
                <p>Taille: {{ $mouton->taille }} cm</p>
                <p>Poids: {{ $mouton->poids }} kg</p>
                <p>Prix: {{ $mouton->prix }} francs</p>
                <p>Date de naissance: {{ $mouton->date_de_naissance }}</p>
                <a href="{{ route('moutons.show', $mouton->id) }}" class="btn btn-primary">Détails</a>
            </div>
        </div>
    </div>
@endforeach
...
<div class="col-12 text-center">
    {{ $moutons->links() }} <!-- Affiche la pagination -->
</div>
