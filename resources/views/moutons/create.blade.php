            ...
            <div class="container position-relative">
                <div class="site-navigation text-center">
                    ...
                    <ul class="js-clone-nav d-none d-lg-inline-block site-menu">
                        ...
                        <li><a href="{{ route('moutons.create') }}">Ajouter un Mouton</a></li>
                        <li><a href="{{ route('indexByOwner') }}">Liste des moutons</a></li>
                ...
                document.getElementById('logout-form').submit();"
                        class="btn-book btn btn-secondary btn-sm ">Deconnexion</a>
                ...
                <div class="col-12">
                    <div class="row justify-content-center ">
                        <div class="col-lg-6 text-center ">
                            <h1 class="mb-4 heading text-white" data-aos="fade-up" data-aos-delay="100">Ajouter Un Mouton</h1>
        ...
        <div class="container">
            ...
            <div class="row mb-5 justify-content-center">
                <div class="col-lg-5 mx-auto order-1" data-aos="fade-up" data-aos-delay="200">
                    <form method="post" action="{{ route('moutons.store') }}" enctype="multipart/form-data" class="form-box">
                        ...
                        <div class="row">
                            <div class="col-12 mb-3">
                                <input id="nom" type="text"
                                    ...
                                    value="{{ old('nom') }}" placeholder="Nom du mouton" required autocomplete="nom">
                            </div>
                            <div class="col-12 mb-3">
                                 <select id="race" name="race" class="form-control" required>
                                        <option value="">Veuillez selectionnez la Race de votre mouton</option>
                            ...
                            <div class="col-12 mb-3">
                                <label for="">Genealogie du mouton</label><br />
                                <textarea type="text" id="genealogie" name="genealogie" class="form-control" required cols="5" rows="5" placeholder="Genealogie du mouton">
                            ...
                            <div class="col-12 mb-3">
                                <input type="number" id="poids" name="poids" class="form-control" required placeholder="Poids du mouton">
                            </div>
                            <div class="col-12 mb-3">
                                <input type="number" id="prix" name="prix" class="form-control" required placeholder="Prix">
                            </div>
                            <div class="col-12 mb-3">
                                <label for="">Date de naissance</label>
                                <input type="date" id="date_de_naissance" name="date_de_naissance" class="form-control" required placeholder="Date de naissance du mouton">
                            </div>
                            <div class="col-12 mb-3">
                            ...
                            <div class="col-12">
                                <input type="submit" value="Ajouter le mouton" class="btn btn-primary">
                            </div>
                        </div>
                    </form>
                </div>
